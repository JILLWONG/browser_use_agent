...
class SearchMetrics(BaseModel):
    ...
    content_fetches: dict[str, int | float] = Field(
        ..., description="Content fetch metrics"
    )
    ...
    def get_metrics(self) -> SearchMetrics:
        ...
        return SearchMetrics(
            ...
            content_fetches={
                ...
                "success_rate": (
                    successful_content_fetches / max(total_content_fetches, 1)
                )
                * 100,
            },
            performance={
...
def get_metrics_collector() -> MetricsCollector:
    ...
    """
    global _metrics_collector  # pylint: disable=global-statement
